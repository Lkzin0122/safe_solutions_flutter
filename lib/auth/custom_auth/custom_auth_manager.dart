...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    safeSolutionsAuthUserSubject.add(
      SafeSolutionsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SafeSolutionsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SafeSolutionsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SafeSolutionsAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    safeSolutionsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SafeSolutionsAuthUser? currentUser;
