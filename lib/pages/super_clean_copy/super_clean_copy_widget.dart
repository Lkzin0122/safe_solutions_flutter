...
import 'super_clean_copy_model.dart';
export 'super_clean_copy_model.dart';

class SuperCleanCopyWidget extends StatefulWidget {
  const SuperCleanCopyWidget({super.key});

  static String routeName = 'SuperCleanCopy';
  static String routePath = '/superCleanCopy';

  @override
  State<SuperCleanCopyWidget> createState() => _SuperCleanCopyWidgetState();
}

class _SuperCleanCopyWidgetState extends State<SuperCleanCopyWidget> {
  late SuperCleanCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuperCleanCopyModel());
  }
